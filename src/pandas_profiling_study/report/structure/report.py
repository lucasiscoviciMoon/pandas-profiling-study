...
from ...report.structure.correlations import get_correlation_items
from ...report.structure.overview import (
    get_dataset_overview,
    get_dataset_reproduction,
    get_dataset_warnings,
)
from ...report.structure.variables import (
    render_boolean,
    render_categorical,
    render_complex,
    render_date,
...
from ...report.presentation.core import (
    Image,
    Sequence,
    Sample,
    Variable,
...
def get_report_structure(
    date_start: datetime, date_end: datetime, sample: dict, summary: dict, sections: list =["overview","variables",'interactions',"correlations","missing","sample"]
) -> Renderable:
    ...
    if corr is not None and "correlations" in sections:
